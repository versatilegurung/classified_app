<div>
    ...
    <div class="container mx-auto px-4 py-10">
        <h3 class="font-bold text-2xl md:text-3xl text-primary py-5">Categories</h3>
        {{-- <div class="grid grid-cols-3 md:grid-cols-6 py-5 gap-5"> --}}
        <div class="flex flex-wrap gap-3">
            @foreach ($categories as $item)
                <a href="{{ $item->id }}">
                    <div class="bg-secondary hover:bg-primary cursor-pointer p-3 rounded-md flex gap-3 justify-between">
