                            ...
                            <table class="table-auto w-full">
                                ...
                                <tbody>
                                    @foreach ($messages as $message)
                                        <tr>
                                            <td class="border px-4 py-2">{{ $message->sender_id }}</td>
                                            <td class="border px-4 py-2">{{ $message->recipient_id }}</td>
                                            {{-- <td class="border px-4 py-2">{{ $message->send_id->diffForHumans() }} --}}
                                            </td>
